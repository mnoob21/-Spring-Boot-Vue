...
import courseTypeManage from "@/views/Admin/courseTypeManage/index";
import addCourse from "@/views/Admin/courseManage/addCourse";
import addCourseType from "@/views/Admin/courseTypeManage/addCourseType";
...
import queryCourseType from "@/views/Admin/courseTypeManage/queryCourseType";
import editorCourseType from "@/views/Admin/courseTypeManage/editorCourseType";
import courseApplication from "@/views/Teacher/courseApplication";
import teacherEditorCourse from "@/views/Teacher/teacherEditorCourse";
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: '/queryCourseType',
            name: '搜索课程类别',
            component: queryCourseType,
            meta: {requireAuth: true},
            children: [
              {
                path: '/courseTypeList',
